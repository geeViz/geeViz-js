...
// Example of how to run CCDC and view outputs using the JavaScript modules
...
// Since CCDC doesn't work well on-the-fly, see the CCCDCViz.js example to view outputs created with this script
// The general workflow for CCDC is to run this script, and then either utilize the harmonic model for a given date
// or to use the breaks for change detection. All of this is demonstrated in the CCDCViz.js example
////////////////////////////////////////////////////////////////////////////////////////////////////
...
var processedScenes = gil.getProcessedLandsatScenes(studyArea, startYear, endYear, startJulian, endJulian, includeSLCOffL7).select(exportBands);


// Remove any extremely high band/index values
function removeGT1(img){
...
if (exportCCDC){
  ...
  var exportName = outputName + "_" + startYear + "_" + endYear + "_" + startJulian + "_" + endJulian;
